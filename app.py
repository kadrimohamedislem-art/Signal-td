# app.py — Professional Gradio Signals (XAU/USD & WTI/USD) — 30min
import os
import gradio as gr
import requests
import pandas as pd
...
# ---------- CONFIG ----------
API_KEY =506f0859dc0f4ff6b30b29d800551be2
if not API_KEY:
...
with gr.Blocks(title="Gold & Oil Signals") as demo:
    gr.Markdown("## 📈 Gold (XAU/USD) & Oil (WTI/USD) Signals — 30min")
